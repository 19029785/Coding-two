...
//This is a class constructor for a Boid object.
...
//These are getter and setter functions in the Boid model, used to retrieve or modify various properties of the Boid, including separation weight (separationWeight), cohesion weight (cohesionWeight), alignment weight (alignmentWeight), separation threshold (separationThreshold), neighbourhood size (neighbourhoodSize), position (position), and velocity (velocity).
